...
In the GreedyWV algorithm, items are sorted by a ratio of value / weight. This ratio allows us to grab the items with the most value to how heavy it weighs.
